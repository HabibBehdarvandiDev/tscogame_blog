...
const AdminNavigation = () => {
  ...
  return (
    <nav className="flex flex-col items-center align-middle justify-start p-1 lg:p-4 max-w-min lg:w-1/5">
      ...
      <div className="nav_links w-full p-1 lg:p-4 min-h-min flex flex-col justify-start align-middle items-start gap-4">
        {AdminDashboardNav.map((link, index) => {
          ...
          return (
            <Link
              key={index}
              href={link.href}
              className={`p-5 w-full rounded-2xl flex justify-start align-middle items-center ${
                isActive
            ...
            >
              <p className="flex text-nowrap text-md align-middle items-center justify-center gap-4">
                <i>{link.icon}</i>
                <span className="hidden lg:inline-flex text-nowrap">
                  {link.title}
                </span>
              </p>
            </Link>
